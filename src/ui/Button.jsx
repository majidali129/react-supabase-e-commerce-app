...
const Button = ({ children, disabled, onClick,type='button', to, variation, className }) => {
  ...
  const variations = {
    ...
    small: 'rounded-full bg-stone-700 text-stone-50 hover:bg-stone-600 ring-2 ring-stone-600 hover:ring-stone-700 w-10 h-10  cursor-pointer disabled:cursor-wait disabled:bg-stone-200 disabled:text-stone-800',
